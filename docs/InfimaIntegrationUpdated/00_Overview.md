...
| Third-person locomotion content | *(does not exist in the pack — confirmed authorial decision)* | `SM_TP_Locomotion` has 1 of 3 states because **there was never source content for the other two**, not because of unfinished wiring | 7 |
