...
#include "MyUI_I.generated.h"

UCLASS()
class WEAPONS_SOUNDS_I_API UMyUI_I : public UUserWidget
{
	GENERATED_BODY()

public:

	UFUNCTION(BlueprintCallable, Category = "MyUI_I Functions")
		void UI_Init();
	UFUNCTION(BlueprintCallable, Category = "MyUI_I Functions")
...
protected:
	...
	//UPROPERTY(BlueprintReadWrite, Category = "MyUI_I Properties")
